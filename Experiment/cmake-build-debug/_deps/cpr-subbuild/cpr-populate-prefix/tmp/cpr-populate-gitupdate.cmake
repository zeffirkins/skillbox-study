...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/Program Files (x86)/Git/cmd/git.exe" rev-parse "${ref}"
...
execute_process(
  COMMAND "C:/Program Files (x86)/Git/cmd/git.exe" show-ref "beb9e98806bb84bcc130a2cebfbcbbc6ce62b335"
  WORKING_DIRECTORY "C:/Users/Iurii/CLionProjects/Experiment/cmake-build-debug/_deps/cpr-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "C:/Program Files (x86)/Git/cmd/git.exe" fetch --tags --force "origin"
    WORKING_DIRECTORY "C:/Users/Iurii/CLionProjects/Experiment/cmake-build-debug/_deps/cpr-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/Program Files (x86)/Git/cmd/git.exe" symbolic-ref -q HEAD
    WORKING_DIRECTORY "C:/Users/Iurii/CLionProjects/Experiment/cmake-build-debug/_deps/cpr-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/Program Files (x86)/Git/cmd/git.exe" for-each-ref "--format='%(upstream:short)'" "${current_branch}"
      WORKING_DIRECTORY "C:/Users/Iurii/CLionProjects/Experiment/cmake-build-debug/_deps/cpr-src"
...
if(need_stash)
  execute_process(
    COMMAND "C:/Program Files (x86)/Git/cmd/git.exe" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "C:/Users/Iurii/CLionProjects/Experiment/cmake-build-debug/_deps/cpr-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/Program Files (x86)/Git/cmd/git.exe" checkout "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/Iurii/CLionProjects/Experiment/cmake-build-debug/_deps/cpr-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "C:/Program Files (x86)/Git/cmd/git.exe" rebase "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/Iurii/CLionProjects/Experiment/cmake-build-debug/_deps/cpr-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Iurii/CLionProjects/Experiment/cmake-build-debug/_deps/cpr-src'."
    ...
    execute_process(
      COMMAND "C:/Program Files (x86)/Git/cmd/git.exe" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Iurii/CLionProjects/Experiment/cmake-build-debug/_deps/cpr-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
