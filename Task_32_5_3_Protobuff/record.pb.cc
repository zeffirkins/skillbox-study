...
const uint32_t TableStruct_record_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Organization, year_foundation_),
  ...
  PROTOBUF_FIELD_OFFSET(::Organization, foreign_economic_),
  3,
  0,
  1,
  2,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_record_2eproto = {
  false, false, 132, descriptor_table_protodef_record_2eproto, "record.proto", 
...
Organization::Organization(const Organization& from)
  ...
  ::memcpy(&year_foundation_, &from.year_foundation_,
    static_cast<size_t>(reinterpret_cast<char*>(&foreign_economic_) -
    reinterpret_cast<char*>(&year_foundation_)) + sizeof(foreign_economic_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&year_foundation_) - reinterpret_cast<char*>(this)),
...
// @@protoc_insertion_point(message_clear_start:Organization)
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&year_foundation_, 0, static_cast<size_t>(
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          year_foundation_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Organization::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(1, this->_internal_year_foundation(), target);
  }
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:Organization)
  ...
  if (_internal_has_year_foundation()) {
    // required int32 year_foundation = 1;
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_year_foundation());
  }
...
void Organization::InternalSwap(Organization* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Organization, foreign_economic_)
      + sizeof(Organization::foreign_economic_)
      - PROTOBUF_FIELD_OFFSET(Organization, year_foundation_)>(
          reinterpret_cast<char*>(&year_foundation_),
          reinterpret_cast<char*>(&other->year_foundation_));
}
