...
// required int32 year_foundation = 1;
inline bool Organization::_internal_has_year_foundation() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool Organization::has_year_foundation() const {
  return _internal_has_year_foundation();
}
inline void Organization::clear_year_foundation() {
  year_foundation_ = 0;
  _has_bits_[0] &= ~0x00000008u;
}
inline int32_t Organization::_internal_year_foundation() const {
  return year_foundation_;
}
inline int32_t Organization::year_foundation() const {
  // @@protoc_insertion_point(field_get:Organization.year_foundation)
  return _internal_year_foundation();
}
inline void Organization::_internal_set_year_foundation(int32_t value) {
  _has_bits_[0] |= 0x00000008u;
  year_foundation_ = value;
}
inline void Organization::set_year_foundation(int32_t value) {
  _internal_set_year_foundation(value);
  // @@protoc_insertion_point(field_set:Organization.year_foundation)
}
...
// optional bool foreign_economic = 5;
inline bool Organization::_internal_has_foreign_economic() const {
  bool value = (_has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool Organization::has_foreign_economic() const {
  return _internal_has_foreign_economic();
}
inline void Organization::clear_foreign_economic() {
  foreign_economic_ = false;
  _has_bits_[0] &= ~0x00000010u;
}
inline bool Organization::_internal_foreign_economic() const {
  return foreign_economic_;
}
inline bool Organization::foreign_economic() const {
  // @@protoc_insertion_point(field_get:Organization.foreign_economic)
  return _internal_foreign_economic();
}
inline void Organization::_internal_set_foreign_economic(bool value) {
  _has_bits_[0] |= 0x00000010u;
  foreign_economic_ = value;
}
inline void Organization::set_foreign_economic(bool value) {
  _internal_set_foreign_economic(value);
  // @@protoc_insertion_point(field_set:Organization.foreign_economic)
}
